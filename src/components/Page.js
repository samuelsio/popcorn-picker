        ...
        return (
            <>
                <Row className="flex-md-row">
                    <Col xs={4} md={3} className="ml-4 mt-4 px-0"><img src={jayPic} alt="Popcorn Picker" style={{ width: '100%' }} /></Col>
                    <h1 className="col flex-shrink-1 mt-5" style={{ color: '#fff', margin: '0.6em 0', fontSize:' 2.2em', fontWeight: '600', lineHeight: '1em', alignSelf: "center" }}>Netflix? <span style={{fontFamily: "Yesteryear, sans-serif", whiteSpace: "nowrap", fontWeight: 100}}>Completed it mate</span></h1>
